...
public class Simulation {
	...
	synchronized public void loadResource(Worker worker) {
		...
		currLorry.load();
		if(currLorry.isFull || (foreman.assignedAll() && currLorry.resCount == this.lastBatch)) {
	 ...
	 * if foreman has next, increase blockNum, because trua answer means, worker will surely get block
